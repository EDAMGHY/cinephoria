...
const badgeVariants = cva(
  "web:inline-flex items-center rounded-full border border-border px-5 py-3 web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        gray: "text-foreground bg-[#2C2C2E]/20 dark:bg-[#2C2C2E] web:hover:opacity-80 active:opacity-80",
      },
    },
    defaultVariants: {
      variant: "default",
