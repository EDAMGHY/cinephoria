  ...
  "group flex items-center justify-center rounded-xl web:ring-offset-background web:transition-colors web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        gray: "bg-[#2C2C2E] web:hover:opacity-90 active:opacity-90",
        white: "bg-white web:hover:opacity-90 active:opacity-90",
        ...
        link: "!px-0 web:underline-offset-4 web:hover:underline web:focus:underline ",
      },
      size: {
        default: "h-[48px] native:h-[48px] px-4 py-2  native:px-5 native:py-3",
